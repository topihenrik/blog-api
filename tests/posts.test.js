...
describe.skip("GET '/api/posts' route", () => { // skipped until post_list structure is removed from the response
    beforeEach(async () => await db.clear());
...
describe("GET 'api/auth/posts/:postid/edit' route", () => {
    beforeEach(async () => await db.clear());
    ...
    test("success: get a post", async () => {
        ...
        await request(app)
            .get(`/api/auth/posts/${utility.initPosts[0]._id}/edit`)
            .set("Authorization", "Bearer " + token)
            .expect(200);
    });
    ...
    test("failure: invalid postid", async () => {
        ...
        await request(app)
            .get("/api/auth/posts/638e710e9e02cc9f183be004/edit")
            .set("Authorization", "Bearer " + token)
            .expect(404);
    });
});
...
describe("GET '/api/auth/posts/:postid' route", () => {
    beforeEach(async () => await db.clear());
    ...
    test("success: get a post", async () => {
        ...
        await request(app)
            .get(`/api/auth/posts/${utility.initPosts[0]._id}`)
            .set("Authorization", "Bearer " + token)
            .expect(200);
    });
    ...
    test("failure: invalid postid", async () => {
        ...
        await request(app)
            .get("/api/auth/posts/638e710e9e02cc9f183be004")
            .set("Authorization", "Bearer " + token)
            .expect(404);
    });
});
